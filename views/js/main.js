...
var randPizzas = document.querySelectorAll(".randomPizzaContainer"); //Run this once --> 100
var resizePizzas = function(size) {
    ...
    //For all pizzas, change to the corresponding size in newWidth array
    for (var i = 0; i < randPizzas.length; i++) {
        var newWidth = [25, 33.3, 50]; //Sizes for pizza
        randPizzas[i].style.width = newWidth[size - 1] + "%"; //Add the percentagage
    }
...
// https://ww w.igvita.com/slides/2012/devtools-tips-and-tricks/jank-demo.html
...
function updatePositions() {
    ...
    //Moved this outside of the loop to reduce calculations needed
    var currentScroll = document.body.scrollTop/1250;
    for (var i = 0; i < items.length; i++) {
        var phase = Math.sin(currentScroll + (i % 5));
